...
//        self.window!.backgroundColor = UIColor(red: 47.0/255.0, green: 73.0/255.0, blue: 110.0/255.0, alpha: 1)
//        self.window!.makeKeyAndVisible()
//        
//        // rootViewController from StoryBoard
//        let mainStoryboard: UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
//        let navigationController = mainStoryboard.instantiateViewControllerWithIdentifier("mainScreen")
//        self.window!.rootViewController = navigationController
//        
//        // logo mask
//        navigationController.view.layer.mask = CALayer()
//        navigationController.view.layer.mask!.contents = UIImage(named: "launchImage")!.CGImage
//        navigationController.view.layer.mask!.bounds = CGRect(x: 0, y: 0, width: 78, height: 90)
...
//        let finalBounds = NSValue(CGRect: CGRect(x: 0, y: 0, width: 10000, height: 10000))
